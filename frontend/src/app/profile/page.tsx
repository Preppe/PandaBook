      ...
      <div className="mx-6 space-y-4">
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-red-500 hover:bg-red-600 disabled:bg-red-300 disabled:cursor-not-allowed text-white rounded-xl transition-colors"
          >
